    ...
    <div className="bg-background-light text-text-main font-display min-h-screen flex flex-col overflow-y-auto antialiased">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg font-bold text-text-main leading-tight">{user?.full_name || '接收员'}</h1>
              <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-primary text-white uppercase tracking-wider">接收方</span>
            </div>
      ...
      <main className="flex-1 overflow-y-auto px-4 py-4 pb-24 flex flex-col gap-4 no-scrollbar">
        ...
        <section
          ...
          className="bg-gradient-to-r from-blue-50 to-indigo-100 rounded-xl p-4 border border-blue-200 shadow-sm relative overflow-hidden cursor-pointer hover:shadow-md transition-all active:scale-[0.99]"
        >
          ...
          <div className="flex justify-between items-center mb-3 relative z-10">
            ...
            <button
              ...
              className="flex items-center gap-1 bg-white/60 hover:bg-white border border-blue-300 rounded-full px-3 py-1 text-xs text-primary font-medium transition-colors"
            >
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/60 rounded-lg p-2.5 border border-white/50">
                <div className="text-[10px] text-gray-500 font-medium mb-0.5">到货总件数</div>
                <div className="flex items-baseline gap-1">
                  <span className="text-lg font-bold text-primary">{activeBatch?.item_count || 0}</span>
                  <span className="text-xs text-gray-500">件</span>
                </div>
              </div>
              <div className="bg-white/60 rounded-lg p-2.5 border border-white/50">
                <div className="text-[10px] text-gray-500 font-medium mb-0.5">到货总重量</div>
                <div className="flex items-baseline gap-1">
                  <span className="text-lg font-bold text-primary">{(activeBatch?.total_weight || 0).toFixed(2)}</span>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
            <div className="text-[10px] text-gray-500 font-medium mb-1 uppercase tracking-wider text-blue-500">待启程批次</div>
            <div className="text-2xl font-bold">{pendingCount}</div>
          </div>
          <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
            <div className="text-[10px] text-gray-500 font-medium mb-1 uppercase tracking-wider text-green-500">运输中批次</div>
        ...
        <section className="grid grid-cols-2 gap-4">
          <button
            onClick={() => navigate('/receiver/check')}
          ...
          >
            <div className="z-10 text-left">
              ...
              <h3 className="text-2xl font-bold text-white">到货签收</h3>
              <p className="text-white/80 text-sm font-medium mt-1">扫描入库 / 货物签收</p>
            </div>
          ...
          <button
            onClick={() => navigate('/receiver/merge')}
          ...
          >
            ...
            <div className="text-left w-full">
              <h3 className="font-bold text-text-main text-lg">包裹合并</h3>
              <p className="text-xs text-gray-500 mt-0.5">分拣出库流转</p>
            </div>
          </button>

          <button
            onClick={() => navigate('/receiver/split')}
          ...
          >
            ...
            <div className="text-left w-full">
              <h3 className="font-bold text-text-main text-lg">包裹拆分</h3>
              <p className="text-xs text-gray-500 mt-0.5">异常包裹处理</p>
            </div>
          </button>
        </section>

        {/* Stats Section */}
        <section className="bg-[#f0f7ff] rounded-xl p-4 border-l-4 border-primary shadow-sm mt-4">
          <div className="flex justify-between items-start mb-1">
            <div className="flex-1">
              ...
              <div className="mb-4">
                <div className="text-[10px] text-gray-500 font-medium mb-0.5">累计签收总件数</div>
              ...
              <div>
                <div className="text-[10px] text-gray-500 font-medium mb-0.5">累计签收总重量</div>
        ...
        <section className="mt-auto">
          <button
            onClick={() => navigate('/receiver/exceptions')}
